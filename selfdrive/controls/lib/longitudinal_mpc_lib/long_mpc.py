...
def get_T_FOLLOW(personality=log.LongitudinalPersonality.standard):
  if personality==log.LongitudinalPersonality.relaxed2:
    return tFollowGap4 #2.0
  elif personality==log.LongitudinalPersonality.relaxed:
    return tFollowGap3 #1.75
  elif personality==log.LongitudinalPersonality.standard:
    return tFollowGap2 #1.45
  elif personality==log.LongitudinalPersonality.aggressive:
    return tFollowGap1 #1.25
  else:
    raise NotImplementedError("Longitudinal personality not supported")
...
class LongitudinalMpc:
  ...
  def update_params(self):
    ...
    if self.lo_timer > 200:
      ...
      tFollowGap1 = float(Params().get_int("TFollowGap1")) / 100.
      tFollowGap2 = float(Params().get_int("TFollowGap2")) / 100.
      tFollowGap3 = float(Params().get_int("TFollowGap3")) / 100.
      tFollowGap4 = float(Params().get_int("TFollowGap4")) / 100.
